...
//                            MainFrame.getInstance().friendsActivityPanelsManager.updateFriendsList(connectedFriend);
                    ...
                    case 3:
                        ...
                        try {
                            ...
                            HomePage.databaseHandler.removeUser(inRequest.getUser().getUsername());
                            HomePage.databaseHandler.addUser(inRequest.getUser());
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        HomePage.databaseHandler.insertPlaylist(playlist);
...
//                        }
                    ...
                    case 5:
                        ...
                        for (String hash : need){
                            Song songToSend = HomePage.databaseHandler.getSongByHash(hash);
    ...
    public void saveProfilePhoto(Request r){
        ...
        try {
            ...
            HomePage.databaseHandler.removeUser(r.getUser().getUsername());
            HomePage.databaseHandler.addUser(r.getUser());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public Request prepareSong(String hash, User target){
        Song s = HomePage.databaseHandler.getSongByHash(hash);
...
//        System.out.println("saving file over network");
        ...
        try {
            ...
            tempSong.add(s);
            HomePage.databaseHandler.deepInsertSong(tempSong);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
